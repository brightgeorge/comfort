...
def auguest_account_mgt(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            ...
            ic.remark = remark
            ic.save()
            return view_auguest_account_details1(request)
...
def sept_account_mgt(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            ...
            ic.remark = remark
            ic.save()
            return view_sept_account_details1(request)
...
def october_account_mgt(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            ...
            ic.remark = remark
            ic.save()
            return view_october_account_details1(request)
...
def nov_account_mgt(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            ...
            ic.remark = remark
            ic.save()
            return view_nov_account_details1(request)
...
def dec_account_mgt(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            ...
            ic.remark = remark
            ic.save()
            return view_dec_account_details1(request)
