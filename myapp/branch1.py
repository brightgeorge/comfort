...
def branch1_dashboard(request):
    if 'username' in request.session:
        ...
        context = {
            ...
            'total_collection_june': admin_dashboard_calculations_br1.total_collection_june(),
            'total_received_june': admin_dashboard_calculations_br1.total_received_june(),
            'total_received_june_list': admin_dashboard_calculations_br1.total_received_june_list(),
            'total_due_june': admin_dashboard_calculations_br1.total_due_june(),
            'total_collection_monthly_june': admin_dashboard_calculations_br1.total_collection_monthly_june(),
            'total_collection_advance_june': admin_dashboard_calculations_br1.total_collection_advance_june(),
            'total_collection_due_june': admin_dashboard_calculations_br1.total_collection_due_june(),
