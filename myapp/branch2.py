...
def branch_index(request):
    if 'username' in request.session:
        return render(request, 'branches/branch2/branch_index.html')

def guest_creation(request):
    if 'username' in request.session:
        context = {
            'rn' : pg2_rooom.objects.all()
        }
        return render(request, 'branches/branch2/guests/guest_creation.html',context)
...
def guest_creation_regi(request):
    ...
    gc.save()
    context = {
        'pg1_guests': pg2_regform.objects.all().filter(flag=1),
    }

    return render(request, 'branches/branch2/guests/view_all_guests.html',context)
...
def update_guest_creation(request,id):
    if request.method == 'POST':
        ...
        gc = pg2_regform.objects.get(id=id)
    ...
    return render(request, 'branches/branch2/guests/update_guest_creation.html',context)
...
def unpaid_rent_choose_months(request):
    if 'username' in request.session:
        return render(request, 'branches/branch2/reports/unpaid_rent_choose_months.html')

def jan_unpaid_rent(request):
    if 'username' in request.session:
        context = {
            'up': pg2_regform.objects.all().filter(jan_rent_flag=100, flag=1).order_by('room_no'),
            'name': request.session['username'],
            'month_name': 'JANUARY'
        }
...
def feb_unpaid_rent(request):
    if 'username' in request.session:
        context = {
            'up': pg2_regform.objects.all().filter(feb_rent_flag=100, flag=1).order_by('room_no'),
            'name': request.session['username'],
            'month_name': 'FEB'
        }
        return render(request, 'branches/branch2/reports/unpaid_rent.html', context)
def mar_unpaid_rent(request):
    if 'username' in request.session:
        context = {
            'up': pg2_regform.objects.all().filter(march_rent_flag=100, flag=1).order_by('room_no'),
            'name': request.session['username'],
            'month_name': 'MARCH'
        }
        return render(request, 'branches/branch2/reports/unpaid_rent.html', context)
def april_unpaid_rent(request):
    if 'username' in request.session:
        context = {
            'up': pg2_regform.objects.all().filter(april_rent_flag=100, flag=1).order_by('room_no'),
            'name': request.session['username'],
            'month_name':'APRIL'
        }
        return render(request, 'branches/branch2/reports/unpaid_rent.html', context)
...
def may_unpaid_rent(request):
    if 'username' in request.session:
        context = {
            'up': pg2_regform.objects.all().filter(may_rent_flag=100, flag=1).order_by('room_no'),
            'name': request.session['username'],
            'month_name': 'MAY'
        }
        return render(request, 'branches/branch2/reports/unpaid_rent.html', context)
def june_unpaid_rent(request):
    if 'username' in request.session:
        context = {
            'up': pg2_regform.objects.all().filter(june_rent_flag=100, flag=1).order_by('room_no'),
            'name': request.session['username'],
            'month_name': 'JUNE'
        }
        return render(request, 'branches/branch2/reports/unpaid_rent.html', context)
def july_unpaid_rent(request):
    if 'username' in request.session:
        context = {
            'up': pg2_regform.objects.all().filter(july_rent_flag=100, flag=1).order_by('room_no'),
            'name': request.session['username'],
            'month_name': 'JULY'
        }
        return render(request, 'branches/branch2/reports/unpaid_rent.html', context)
def aug_unpaid_rent(request):
    if 'username' in request.session:
        context = {
            'up': pg2_regform.objects.all().filter(aug_rent_flag=100, flag=1).order_by('room_no'),
            'name': request.session['username'],
            'month_name': 'AUGUST'
        }
        return render(request, 'branches/branch2/reports/unpaid_rent.html', context)
...
def sept_unpaid_rent(request):
    if 'username' in request.session:
        context = {
            'up': pg2_regform.objects.all().filter(sept_rent_flag=100, flag=1).order_by('room_no'),
            'name': request.session['username'],
            'month_name': 'SEPT'
        }
        return render(request, 'branches/branch2/reports/unpaid_rent.html', context)
def oct_unpaid_rent(request):
    if 'username' in request.session:
        context = {
            'up': pg2_regform.objects.all().filter(oct_rent_flag=100, flag=1).order_by('room_no'),
            'name': request.session['username'],
            'month_name': 'OCTOBER'
        }
        return render(request, 'branches/branch2/reports/unpaid_rent.html', context)
def nov_unpaid_rent(request):
    if 'username' in request.session:
        context = {
            'up': pg2_regform.objects.all().filter(nov_rent_flag=100, flag=1).order_by('room_no'),
            'name': request.session['username'],
            'month_name': 'NOVEMBER'
        }
        return render(request, 'branches/branch2/reports/unpaid_rent.html', context)
...
def dec_unpaid_rent(request):
    if 'username' in request.session:
        context = {
            'up': pg2_regform.objects.all().filter(dec_rent_flag=100, flag=1).order_by('room_no').order_by('room_no'),
            'name': request.session['username'],
            'month_name': 'DECEMBER'
        }
        return render(request, 'branches/branch2/reports/unpaid_rent.html', context)
