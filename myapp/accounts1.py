...
def view_all_category_delete(request):
    context = {
...
def view_all_items_delete(request):
    context = {
...
def view_all_ledger_delete(request):
    context = {
...
def view_all_accounts_book_delete(request):
    context = {
...
def detailed_journal_report(request):
    context = {
...
def journal_report_deleted(request):
    context = {
...
def daily_item_based_reports(request):
    particular = request.POST.get('item')
    dates = request.POST.get('day')
    import datetime
    if dates == None:
...
def monthly_item_based_reports(request):
    particular = request.POST.get('item')
    month = request.POST.get('month')
...
def daily_accounts_book_based_reports(request):
    accounts_book_name = request.POST.get('accounts_book_name')
    dates = request.POST.get('day')
    import datetime
    if dates == None:
...
def monthly_accounts_book_based_reports(request):
    accounts_book_name = request.POST.get('accounts_book_name')
    month = request.POST.get('month')
...
def monthly_daily_in_exp_items_report(request):
    ...
    queryset = in_exp_items_daily.objects.filter(month='08',type='income',flag=1)
    totals = queryset.aggregate(sum=Sum('amount'))

    ob = opening_balance.objects.all().filter(month_no='08',month_name='aug',flag=1)
    l_opening_balance=[]
    for i in ob:
    ...
    income_1 = in_exp_items_daily.objects.filter(month='08', type='income', day='01',flag=1)
    l_income_1 = []
    for i in income_1:
        l_income_1.append(float(i.amount))
    r_income_1 = sum(l_income_1)
    expense_1 = in_exp_items_daily.objects.filter(month='08', type='expense', day='01',flag=1)
    l_expense_1 = []
    for i in expense_1:
    ...
    income_2 = in_exp_items_daily.objects.filter(month='08', type='income', day='02',flag=1)
    l_income_2 = []
    for i in income_2:
        l_income_2.append(float(i.amount))
    r_income_2 = sum(l_income_2)
    expense_2 = in_exp_items_daily.objects.filter(month='08', type='expense', day='02',flag=1)
    l_expense_2 = []
    for i in expense_2:
    ...
    income_3 = in_exp_items_daily.objects.filter(month='08', type='income', day='03',flag=1)
    l_income_3 = []
    for i in income_3:
        l_income_3.append(float(i.amount))
    r_income_3 = sum(l_income_3)
    expense_3 = in_exp_items_daily.objects.filter(month='08', type='expense', day='03',flag=1)
    l_expense_3 = []
    for i in expense_3:
    ...
    income_4 = in_exp_items_daily.objects.filter(month='08', type='income', day='04',flag=1)
    l_income_4 = []
    for i in income_4:
        l_income_4.append(float(i.amount))
    r_income_4 = sum(l_income_4)
    expense_4 = in_exp_items_daily.objects.filter(month='08', type='expense', day='04',flag=1)
    l_expense_4 = []
    for i in expense_4:
    ...
    income_5 = in_exp_items_daily.objects.filter(month='08', type='income', day='05',flag=1)
    l_income_5 = []
    for i in income_5:
        l_income_5.append(float(i.amount))
    r_income_5 = sum(l_income_5)
    expense_5 = in_exp_items_daily.objects.filter(month='08', type='expense', day='05',flag=1)
    l_expense_5 = []
    for i in expense_5:
    ...
    income_6 = in_exp_items_daily.objects.filter(month='08', type='income', day='06',flag=1)
    l_income_6 = []
    for i in income_6:
        l_income_6.append(float(i.amount))
    r_income_6 = sum(l_income_6)
    expense_6 = in_exp_items_daily.objects.filter(month='08', type='expense', day='06',flag=1)
    l_expense_6 = []
    for i in expense_6:
    ...
    income_7 = in_exp_items_daily.objects.filter(month='08', type='income', day='07',flag=1)
    l_income_7 = []
    for i in income_7:
        l_income_7.append(float(i.amount))
    r_income_7 = sum(l_income_7)
    expense_7 = in_exp_items_daily.objects.filter(month='08', type='expense', day='07',flag=1)
    l_expense_7 = []
    for i in expense_7:
...
###***************************************
    income_8 = in_exp_items_daily.objects.filter(month='08', type='income', day='08',flag=1)
    l_income_8 = []
    for i in income_8:
        l_income_8.append(float(i.amount))
    r_income_8 = sum(l_income_8)
    expense_8 = in_exp_items_daily.objects.filter(month='08', type='expense', day='08',flag=1)
    l_expense_8 = []
    for i in expense_8:
    ...
    income_9 = in_exp_items_daily.objects.filter(month='08', type='income', day='09',flag=1)
    l_income_9 = []
    for i in income_9:
        l_income_9.append(float(i.amount))
    r_income_9 = sum(l_income_9)
    expense_9 = in_exp_items_daily.objects.filter(month='08', type='expense', day='09',flag=1)
    l_expense_9 = []
    for i in expense_9:
    ...
    income_10 = in_exp_items_daily.objects.filter(month='08', type='income', day='10',flag=1)
    l_income_10 = []
    for i in income_10:
        l_income_10.append(float(i.amount))
    r_income_10 = sum(l_income_10)
    expense_10 = in_exp_items_daily.objects.filter(month='08', type='expense', day='10',flag=1)
    l_expense_10 = []
    for i in expense_10:
    ...
    income_11 = in_exp_items_daily.objects.filter(month='08', type='income', day='11',flag=1)
    l_income_11 = []
    for i in income_11:
        l_income_11.append(float(i.amount))
    r_income_11 = sum(l_income_11)
    expense_11 = in_exp_items_daily.objects.filter(month='08', type='expense', day='11',flag=1)
    l_expense_11 = []
    for i in expense_11:
    ...
    income_12 = in_exp_items_daily.objects.filter(month='08', type='income', day='12',flag=1)
    l_income_12 = []
    for i in income_12:
        l_income_12.append(float(i.amount))
    r_income_12 = sum(l_income_12)
    expense_12 = in_exp_items_daily.objects.filter(month='08', type='expense', day='12',flag=1)
    l_expense_12 = []
    for i in expense_12:
    ...
    income_13 = in_exp_items_daily.objects.filter(month='08', type='income', day='13',flag=1)
    l_income_13 = []
    for i in income_13:
        l_income_13.append(float(i.amount))
    r_income_13 = sum(l_income_13)
    expense_13 = in_exp_items_daily.objects.filter(month='08', type='expense', day='13',flag=1)
    l_expense_13 = []
    for i in expense_13:
    ...
    income_14 = in_exp_items_daily.objects.filter(month='08', type='income', day='14',flag=1)
    l_income_14 = []
    for i in income_14:
        l_income_14.append(float(i.amount))
    r_income_14 = sum(l_income_14)
    expense_14 = in_exp_items_daily.objects.filter(month='08', type='expense', day='14',flag=1)
    l_expense_14 = []
    for i in expense_14:
...
###*****************************
    income_15 = in_exp_items_daily.objects.filter(month='08', type='income', day='15',flag=1)
    l_income_15 = []
    for i in income_15:
        l_income_15.append(float(i.amount))
    r_income_15 = sum(l_income_15)
    expense_15 = in_exp_items_daily.objects.filter(month='08', type='expense', day='15',flag=1)
    l_expense_15 = []
    for i in expense_15:
    ...
    income_16 = in_exp_items_daily.objects.filter(month='08', type='income', day='16',flag=1)
    l_income_16 = []
    for i in income_16:
        l_income_16.append(float(i.amount))
    r_income_16 = sum(l_income_16)
    expense_16 = in_exp_items_daily.objects.filter(month='08', type='expense', day='16',flag=1)
    l_expense_16 = []
    for i in expense_16:
    ...
    income_17 = in_exp_items_daily.objects.filter(month='08', type='income', day='17',flag=1)
    l_income_17 = []
    for i in income_17:
        l_income_17.append(float(i.amount))
    r_income_17 = sum(l_income_17)
    expense_17 = in_exp_items_daily.objects.filter(month='08', type='expense', day='17',flag=1)
    l_expense_17 = []
    for i in expense_17:
    ...
    income_18 = in_exp_items_daily.objects.filter(month='08', type='income', day='18',flag=1)
    l_income_18 = []
    for i in income_18:
        l_income_18.append(float(i.amount))
    r_income_18 = sum(l_income_18)
    expense_18 = in_exp_items_daily.objects.filter(month='08', type='expense', day='18',flag=1)
    l_expense_18 = []
    for i in expense_18:
    ...
    income_19 = in_exp_items_daily.objects.filter(month='08', type='income', day='19',flag=1)
    l_income_19 = []
    for i in income_19:
        l_income_19.append(float(i.amount))
    r_income_19 = sum(l_income_19)
    expense_19 = in_exp_items_daily.objects.filter(month='08', type='expense', day='19',flag=1)
    l_expense_19 = []
    for i in expense_19:
    ...
    income_20 = in_exp_items_daily.objects.filter(month='08', type='income', day='20',flag=1)
    l_income_20 = []
    for i in income_20:
        l_income_20.append(float(i.amount))
    r_income_20 = sum(l_income_20)
    expense_20 = in_exp_items_daily.objects.filter(month='08', type='expense', day='20',flag=1)
    l_expense_20 = []
    for i in expense_20:
    ...
    income_21 = in_exp_items_daily.objects.filter(month='08', type='income', day='21',flag=1)
    l_income_21 = []
    for i in income_21:
        l_income_21.append(float(i.amount))
    r_income_21 = sum(l_income_21)
    expense_21 = in_exp_items_daily.objects.filter(month='08', type='expense', day='21',flag=1)
    l_expense_21 = []
    for i in expense_21:
    ...
    income_22 = in_exp_items_daily.objects.filter(month='08', type='income', day='22',flag=1)
    l_income_22 = []
    for i in income_22:
        l_income_22.append(float(i.amount))
    r_income_22 = sum(l_income_22)
    expense_22 = in_exp_items_daily.objects.filter(month='08', type='expense', day='22',flag=1)
    l_expense_22 = []
    for i in expense_22:
...
####************************
    income_23 = in_exp_items_daily.objects.filter(month='08', type='income', day='23',flag=1)
    l_income_23 = []
    for i in income_23:
        l_income_23.append(float(i.amount))
    r_income_23 = sum(l_income_23)
    expense_23 = in_exp_items_daily.objects.filter(month='08', type='expense', day='23',flag=1)
    l_expense_23 = []
    for i in expense_23:
    ...
    income_24 = in_exp_items_daily.objects.filter(month='08', type='income', day='24',flag=1)
    l_income_24 = []
    for i in income_24:
        l_income_24.append(float(i.amount))
    r_income_24 = sum(l_income_24)
    expense_24 = in_exp_items_daily.objects.filter(month='08', type='expense', day='24',flag=1)
    l_expense_24 = []
    for i in expense_24:
    ...
    income_25 = in_exp_items_daily.objects.filter(month='08', type='income', day='25',flag=1)
    l_income_25 = []
    for i in income_25:
        l_income_25.append(float(i.amount))
    r_income_25 = sum(l_income_25)
    expense_25 = in_exp_items_daily.objects.filter(month='08', type='expense', day='25',flag=1)
    l_expense_25 = []
    for i in expense_25:
    ...
    income_26 = in_exp_items_daily.objects.filter(month='08', type='income', day='26',flag=1)
    l_income_26 = []
    for i in income_26:
        l_income_26.append(float(i.amount))
    r_income_26 = sum(l_income_26)
    expense_26 = in_exp_items_daily.objects.filter(month='08', type='expense', day='26',flag=1)
    l_expense_26 = []
    for i in expense_26:
    ...
    income_27 = in_exp_items_daily.objects.filter(month='08', type='income', day='27',flag=1)
    l_income_27 = []
    for i in income_27:
        l_income_27.append(float(i.amount))
    r_income_27 = sum(l_income_27)
    expense_27 = in_exp_items_daily.objects.filter(month='08', type='expense', day='27',flag=1)
    l_expense_27 = []
    for i in expense_27:
    ...
    income_28 = in_exp_items_daily.objects.filter(month='08', type='income', day='28',flag=1)
    l_income_28 = []
    for i in income_28:
        l_income_28.append(float(i.amount))
    r_income_28 = sum(l_income_28)
    expense_28 = in_exp_items_daily.objects.filter(month='08', type='expense', day='28',flag=1)
    l_expense_28 = []
    for i in expense_28:
...
####**************************
    income_29 = in_exp_items_daily.objects.filter(month='08', type='income', day='29',flag=1)
    l_income_29 = []
    for i in income_29:
        l_income_29.append(float(i.amount))
    r_income_29 = sum(l_income_29)
    expense_29 = in_exp_items_daily.objects.filter(month='08', type='expense', day='29',flag=1)
    l_expense_29 = []
    for i in expense_29:
    ...
    income_30 = in_exp_items_daily.objects.filter(month='08', type='income', day='30',flag=1)
    l_income_30 = []
    for i in income_30:
        l_income_30.append(float(i.amount))
    r_income_30 = sum(l_income_30)
    expense_30 = in_exp_items_daily.objects.filter(month='08', type='expense', day='30',flag=1)
    l_expense_30 = []
    for i in expense_30:
    ...
    income_31 = in_exp_items_daily.objects.filter(month='08', type='income', day='31',flag=1)
    l_income_31 = []
    for i in income_31:
        l_income_31.append(float(i.amount))
    r_income_31 = sum(l_income_31)
    expense_31 = in_exp_items_daily.objects.filter(month='08', type='expense', day='31',flag=1)
    l_expense_31 = []
    for i in expense_31:
...
##****************************************
    a = in_exp_items_daily.objects.all().filter(month='08',flag=1)
    il=[]
    el=[]
    for i in a:
        if i.type == 'income':
    ...
    context = {
        ...
        'totals': totals,
        'res' : in_exp_items_daily.objects.all().filter(month='08',flag=1),
...
def monthly_detailed_daily_in_exp_items_report(request,mo):
    ...
    income_5 = in_exp_items_daily.objects.filter(month='09', type='income', day='05',flag=1)
    l_income_5 = []
    for i in income_5:
        l_income_5.append(float(i.amount))
    r_income_5 = sum(l_income_5)
    expense_5 = in_exp_items_daily.objects.filter(month='09', type='expense', day='05',flag=1)
    l_expense_5 = []
    for i in expense_5:
        l_expense_5.append(float(i.amount))
    r_expense_5 = sum(l_expense_5)
    ...
    income_6 = in_exp_items_daily.objects.filter(month='09', type='income', day='06',flag=1)
    l_income_6 = []
    for i in income_6:
        l_income_6.append(float(i.amount))
    r_income_6 = sum(l_income_6)
...
def sep_single_daily_in_exp_items_report(request):
    context={

    }
    return render(request,'branches/branch1/accounts/monthly_reports/sep/sep_single_daily_in_exp_items_report.html',context)
