...
def may_details_live9(request):
    if 'username' in request.session:
        ...
        return render(request, 'branches/branch9/live_print_report/live_monthly_details/may/may_details_live.html',
                      context)
    return render(request, 'index.html')
...
def july_details_live9(request):
    if 'username' in request.session:
        ...
        return render(request, 'branches/branch9/live_print_report/live_monthly_details/july/july_details_live.html',
                      context)
    return render(request, 'index.html')
