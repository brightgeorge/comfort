# admin_dashboard_calculations_br9
...
def total_collection_june():
    ...
    total_advance_amt = []
    total_due_amt = []
    total_guest_br9 = branch9app.models.pg1_new_guest.objects.all().filter(flag=2)
    for i in total_guest_br9:
    ...
    total_discout_amt = []
    pg1_new_beds = branch9app.models.pg1_new_guest.objects.all().filter(flag=2)
