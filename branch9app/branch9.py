...
def active_guest_details9(request,guest_code):
    ...
    return render(request, 'branches/branch9/new_guest/active_guest_details.html', context)





def view_all_guest9(request):
    ...
    return render(request,'branches/branch9/new_guest/view_all_guest.html',context)

def shift_guest9(request,id):
    ...
    return render(request,'branches/branch9/new_guest/shift_guest.html',context)




def shift_guest_regi9(request):
...
def unpaid_rent_choose_months9(request):
    if 'username' in request.session:
        ...
        return render(request, 'branches/branch9/reports/unpaid_rent/unpaid_rent_choose_months.html',context)
...
def paid_rent_choose_months9(request):
    if 'username' in request.session:
        ...
        return render(request, 'branches/branch9/reports/paid_rent/paid_rent_choose_months.html',context)
...
def choose_months_advance9(request):
    if 'username' in request.session:
        ...
        return render(request, 'branches/branch9/advance/choose_months_advance.html',context)
...
def choose_months9(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch9/payments/choose_months.html',context)
...
def get_total_due_year_end9(request):
    if 'username' in request.session:
        l = []
        data = pg1_new_beds.objects.all()
        for i in data:
        ...
        return render(request, 'branches/branch9/print_outs/get_total_due_year_end.html', context)
    return render(request, 'index.html')
...
def due_amt_mgt_choose_months9(request):
    ...
    return render(request, 'branches/branch9/due_amt_mgt/due_amt_mgt_choose_months.html',context)
...
def guest_details9(request,guest_code):
    ...
    return render(request, 'branches/branch9/vacate_guest/guest_details.html', context)
