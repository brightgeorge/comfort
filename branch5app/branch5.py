...
def active_guest_details5(request,guest_code):
...
def table_jan_paid_rent5(request):
    if 'username' in request.session:
        l = []
        unp = pg1_new_guest.objects.all().filter(jan_rent_flag=200, flag=1)
        for i in unp:
...
def table_feb_paid_rent5(request):
    if 'username' in request.session:
        l = []
        unp = pg1_new_guest.objects.all().filter(feb_rent_flag=200, flag=1)
        for i in unp:
...
def table_mar_paid_rent5(request):
    if 'username' in request.session:
        l = []
        unp = pg1_new_guest.objects.all().filter(march_rent_flag=200, flag=1)
        for i in unp:
...
def table_april_paid_rent5(request):
    if 'username' in request.session:
        l = []
        unp = pg1_new_guest.objects.all().filter(april_rent_flag=200, flag=2)
        for i in unp:
...
def table_may_paid_rent5(request):
    if 'username' in request.session:
        l = []
        unp = pg1_new_guest.objects.all().filter(may_rent_flag=200, flag=2)
        for i in unp:
...
def table_june_paid_rent5(request):
    if 'username' in request.session:
        l = []
        unp = pg1_new_guest.objects.all().filter(june_rent_flag=200, flag=2)
        for i in unp:
...
def table_july_paid_rent5(request):
    if 'username' in request.session:
        l = []
        unp = pg1_new_guest.objects.all().filter(july_rent_flag=200, flag=2)
        for i in unp:
...
def table_aug_paid_rent5(request):
    if 'username' in request.session:
        l = []
        unp = pg1_new_guest.objects.all().filter(auguest_rent_flag=200, flag=2)
        for i in unp:
...
def table_oct_paid_rent5(request):
    if 'username' in request.session:
        l = []
        unp = pg1_new_guest.objects.all().filter(october_rent_flag=200, flag=2)
        for i in unp:
...
def table_nov_paid_rent5(request):
    if 'username' in request.session:
        l = []
        unp = pg1_new_guest.objects.all().filter(nov_rent_flag=200, flag=2)
        for i in unp:
...
def table_dec_paid_rent5(request):
    if 'username' in request.session:
        l = []
        unp = pg1_new_guest.objects.all().filter(dec_rent_flag=200, flag=2)
        for i in unp:
...
def get_total_due_year_end5(request):
    if 'username' in request.session:
        l = []
        data = pg1_new_beds.objects.all()
        for i in data:
        ...
        return render(request, 'branches/branch5/print_outs/get_total_due_year_end.html', context)
    return render(request, 'index.html')
...
def full_vacated_guest_table5(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def view_jan_account_details5(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def jan_account_mgt5(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            ...
            ic.jan_rent_flag = chk
            ic.save()
            return view_jan_account_details5(request)
...
def view_feb_account_details5(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def feb_account_mgt5(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            paid_amt = request.POST.get('pamt')
            advance = request.POST.get('adv')
            ...
            ic.feb_rent_flag = chk
            ic.save()
            return view_feb_account_details5(request)
...
def view_march_account_details5(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def march_account_mgt5(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            paid_amt = request.POST.get('pamt')
            advance = request.POST.get('adv')
            ...
            ic.march_rent_flag = chk
            ic.save()
            return view_march_account_details5(request)
...
def view_april_account_details5(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def april_account_mgt5(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            paid_amt = request.POST.get('pamt')
            advance = request.POST.get('adv')
            ...
            ic.april_rent_flag = chk
            ic.save()
            return view_april_account_details5(request)
...
def view_auguest_account_details5(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def auguest_account_mgt5(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            paid_amt = request.POST.get('pamt')
            advance = request.POST.get('adv')
            ...
            ic.auguest_rent_flag = chk
            ic.save()
            return view_auguest_account_details5(request)
...
def view_sept_account_details5(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def sept_account_mgt5(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            paid_amt = request.POST.get('pamt')
            advance = request.POST.get('adv')
            ...
            ic.sept_rent_flag = chk
            ic.save()
            return view_sept_account_details5(request)
...
def view_october_account_details5(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def october_account_mgt5(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            paid_amt = request.POST.get('pamt')
            advance = request.POST.get('adv')
            ...
            ic.october_rent_flag = chk
            ic.save()
            return view_october_account_details5(request)
...
def view_nov_account_details5(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def nov_account_mgt5(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            paid_amt = request.POST.get('pamt')
            advance = request.POST.get('adv')
            ...
            ic.nov_rent_flag = chk
            ic.save()
            return view_nov_account_details5(request)
...
def view_dec_account_details5(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def dec_account_mgt5(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            paid_amt = request.POST.get('pamt')
            advance = request.POST.get('adv')
            ...
            ic.dec_rent_flag = chk
            ic.save()
            return view_dec_account_details5(request)
