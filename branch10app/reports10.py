...
def detailed_report_choose_months_ob_ch(request):
...
def jan_details_live_ob_ch(request):
    if 'username' in request.session:
...
def feb_details_live_ob_ch(request):
    if 'username' in request.session:
...
def march_details_live_ob_ch(request):
    if 'username' in request.session:
...
def april_details_live_ob_ch(request):
    if 'username' in request.session:
...
def may_details_live_ob_ch(request):
    if 'username' in request.session:
...
def auguest_details_live_ob_ch(request):
    if 'username' in request.session:
...
def sept_details_live_ob_ch(request):
    if 'username' in request.session:
...
def october_details_live_ob_ch(request):
    if 'username' in request.session:
...
def nov_details_live_ob_ch(request):
    if 'username' in request.session:
...
def dec_details_live_ob_ch(request):
    if 'username' in request.session:
...
def viewall_vaccant_room_ob_ch(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def full_paid_guest_ob_ch(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def partially_paid_guest_choose_months_ob_ch(request):
    if 'username' in request.session:
