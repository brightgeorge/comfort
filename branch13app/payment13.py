...
def choose_user_ob_ch13(request):
    if 'username' in request.session:
        ...
        d={'1':'get_total_due_feb','2':'get_total_due_march',
           ...
           '_ob_ch13':'get_total_due_june','6':'get_total_due_july',
        ...
        return render(request, 'branches/branch13/payments/choose_user.html',context)
def payment_user_details_ob_ch13(request, id):
    if 'username' in request.session:
        ...
        return render(request, 'branches/branch13/payments/payment_user_details.html', context)



def close_choose_user_ob_ch13(request,id):
    if 'username' in request.session:
        from datetime import datetime
...
def monthly_jan_make_payments_ob_ch13(request,id):
    if 'username' in request.session:
        ...
        return render(request, 'branches/branch13/payments/payment_details_of_months/jan/monthly_jan_manke_payments.html', context)

#jan make payments start here

#feb make payments start here

def monthly_feb_make_payments_ob_ch13(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt=request.POST.get('janamt')
            remark = request.POST.get('janremark')
        ...
        return render(request, 'branches/branch13/payments/payment_details_of_months/feb/monthly_feb_manke_payments.html', context)

#feb make payments start here

#march make payments start here

def monthly_march_make_payments_ob_ch13(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt=request.POST.get('janamt')
            remark = request.POST.get('janremark')
        ...
        return render(request, 'branches/branch13/payments/payment_details_of_months/march/monthly_march_manke_payments.html', context)
...
def monthly_april_make_payments_ob_ch13(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt=request.POST.get('janamt')
            remark = request.POST.get('janremark')
        ...
        return render(request, 'branches/branch13/payments/payment_details_of_months/april/monthly_april_make_payments.html', context)
...
def monthly_may_make_payments_ob_ch13(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt=request.POST.get('janamt')
            remark = request.POST.get('janremark')
        ...
        return render(request, 'branches/branch13/payments/payment_details_of_months/may/monthly_may_make_payments.html', context)

#may make payments start here

#june make payments start here

def monthly_june_make_payments_ob_ch13(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt=request.POST.get('janamt')
            remark = request.POST.get('janremark')
        ...
        return render(request, 'branches/branch13/payments/payment_details_of_months/june/monthly_june_make_payments.html', context)
...
def monthly_july_make_payments_ob_ch13(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt=request.POST.get('janamt')
            remark = request.POST.get('janremark')
        ...
        return render(request,'branches/branch13/payments/payment_details_of_months/july/monthly_july_make_payments.html', context)

#july make payments end here

#agu make payments start here

def monthly_aug_make_payments_ob_ch13(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt=request.POST.get('janamt')
            remark = request.POST.get('janremark')
        ...
        return render(request,'branches/branch13/payments/payment_details_of_months/aug/monthly_aug_make_payments.html', context)

#aug make payments start here

#sept make payments start here

def monthly_sept_make_payments_ob_ch13(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt=request.POST.get('janamt')
            remark = request.POST.get('janremark')
        ...
        return render(request,'branches/branch13/payments/payment_details_of_months/sept/monthly_sept_make_payments.html', context)

#sept make payments start here

#oct make payments start here

def monthly_oct_make_payments_ob_ch13(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt=request.POST.get('janamt')
            remark = request.POST.get('janremark')
        ...
        return render(request,'branches/branch13/payments/payment_details_of_months/oct/monthly_oct_make_payments.html', context)

#oct make payments start here

#nov make payments start here

def monthly_nov_make_payments_ob_ch13(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt=request.POST.get('janamt')
            remark = request.POST.get('janremark')
        ...
        return render(request,'branches/branch13/payments/payment_details_of_months/nov/monthly_nov_make_payments.html', context)

#nov make payments start here

#dec make payments start here

def monthly_dec_make_payments_ob_ch13(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt=request.POST.get('janamt')
            remark = request.POST.get('janremark')
        ...
        return render(request,'branches/branch13/payments/payment_details_of_months/dec/monthly_dec_make_payments.html', context)
