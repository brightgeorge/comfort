...
def branch1_room_create_ob_ch13(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch13/rooms/create_room.html',context)
    return render(request, 'index.html')

def branch1_room_create_regi_ob_ch13(request):
    if 'username' in request.session:
        if request.method == 'POST':
            ...
            if chk_room == True:
                ...
                return render(request, 'branches/branch13/rooms/view_all_rooms.html', context)
            else:
...
def view_all_room_ob_ch13(request):
    if 'username' in request.session:
...
def delete_room_ob_ch13(request,id):
    if 'username' in request.session:
...
def pg1_bed_create_ob_ch13(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch13/beds/create_beds.html',context)
    return render(request, 'index.html')

def pg1_bed_create_regi_ob_ch13(request):
    if 'username' in request.session:
        if request.method == 'POST':
            ...
            if chk_bd_code == True:
                ...
                return render(request, 'branches/branch13/beds/view_all_beds.html', context)
            else:
...
def single_pg1_bed_create_regi_ob_ch13(request):
    if 'username' in request.session:
        if request.method == 'POST':
...
def pg1_view_all_beds_ob_ch13(request):
    if 'username' in request.session:
...
def delete_bed_ob_ch13(request,id):
    if 'username' in request.session:
...
def update_bed_basic_details_ob_ch13(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            room_type = request.POST.get('roomtype')
            ...
            return pg1_view_all_beds_ob_ch13(request)
        ...
        messages.info(request, ' Room Created Sucessfully')
        return render(request, 'branches/branch13/beds/update_bed.html', context)
    return render(request,'index.html')
