    ...
    if 'username' in request.session:
        if request.method == 'POST':
            ...
            if chk_mob == True:
                ...
                messages.info(request, 'BRANCH_ob_ch11 guest created sucessfully')
                # return render(request, 'branches/branch1/new_guest/view_all_new_guest.html', context)
                return view_all_new_guest_ob_ch11(request)
...
def get_total_due_year_end_ob_ch11(request):
    if 'username' in request.session:
        ag = pg1_new_beds.objects.all().order_by('roon_no')
        l = []
        t = []
        ...
        return render(request, 'branches/branch11/print_outs/get_total_due_year_end.html', context)
    return render(request, 'index.html')
