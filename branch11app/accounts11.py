...
from branch11app.models import table1,in_exp_items_daily,opening_balance,category,ledger,accounts_book,background_color
...
def accounts_dash_board11(request):
    if 'username' in request.session:
