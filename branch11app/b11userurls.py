...
urlpatterns = [
    ...
    path('branch1_dashboard11/', branch11.branch1_dashboard11, name='branch1_dashboard11'),
...
###################################################################################
    ...
    path('accounts_dash_board11/',accounts11.accounts_dash_board11,name='accounts_dash_board11'),
