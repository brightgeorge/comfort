...
def branch1_dashboard8(request):
    if 'username' in request.session:
        ...
        context = {
            ...
            'total_collection_june': admin_dashboard_calculations_br8.total_collection_june(),
            'total_received_june': admin_dashboard_calculations_br8.total_received_june(),
            'total_received_june_list': admin_dashboard_calculations_br8.total_received_june_list(),
            'total_due_june': admin_dashboard_calculations_br8.total_due_june(),
            'total_collection_monthly_june': admin_dashboard_calculations_br8.total_collection_monthly_june(),
            'total_collection_advance_june': admin_dashboard_calculations_br8.total_collection_advance_june(),
            'total_collection_due_june': admin_dashboard_calculations_br8.total_collection_due_june(),
...
def admit_guest8(request):
    return render(request, 'branches/branch8/new_guest/admit_guest.html')
...
def unpaid_rent_choose_months8(request):
    if 'username' in request.session:
        return render(request, 'branches/branch8/reports/unpaid_rent/unpaid_rent_choose_months.html')
...
def paid_rent_choose_months8(request):
    if 'username' in request.session:
        return render(request, 'branches/branch8/reports/paid_rent/paid_rent_choose_months.html')
...
def choose_months_advance8(request):
    if 'username' in request.session:
        return render(request, 'branches/branch8/advance/choose_months_advance.html')
...
def choose_months8(request):
    if 'username' in request.session:
        return render(request,'branches/branch8/payments/choose_months.html')
