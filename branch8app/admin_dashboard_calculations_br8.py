#admin_dashboard_calculations_br8
...
def total_collection_june():
    ...
    total_advance_amt = []
    total_due_amt = []
    total_guest_br8 = branch8app.models.pg1_new_guest.objects.all().filter(flag=2)
    for i in total_guest_br8:
    ...
    total_discout_amt = []
    pg1_new_beds = branch8app.models.pg1_new_guest.objects.all().filter(flag=2)
