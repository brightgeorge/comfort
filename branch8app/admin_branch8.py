...
def branch1_room_create8(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch8/rooms/create_room.html',context)
    return render(request, 'index.html')

def branch1_room_create_regi8(request):
    if 'username' in request.session:
        if request.method == 'POST':
            ...
            if chk_room == True:
                ...
                messages.info(request, 'BRANCH8 roon no already exists')
                return render(request, 'branches/branch8/rooms/view_all_rooms.html', context)
            else:
                ...
                messages.info(request, 'BRANCH8 room created sucessfully')
                return render(request,'branches/branch8/rooms/view_all_rooms.html',context)
    return render(request, 'index.html')

def view_all_room8(request):
    if 'username' in request.session:
...
def pg1_bed_create8(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch8/beds/create_beds.html',context)
    return render(request, 'index.html')

def pg1_bed_create_regi8(request):
    if 'username' in request.session:
        if request.method == 'POST':
            ...
            if chk_bd_code == True:
                ...
                messages.info(request, 'BRANCH8 bed no already exists')
                return render(request, 'branches/branch8/beds/view_all_beds.html', context)
            else:
...
def single_pg1_bed_create_regi8(request):
    if 'username' in request.session:
        if request.method == 'POST':
...
def pg1_view_all_beds8(request):
    if 'username' in request.session:
        ...
        context = {
            ...
            'brname': 'BRANCH 8 Room',
            'br': pg1_new_beds.objects.all().order_by('roon_no')
        }
        return render(request,'branches/branch8/beds/view_all_beds.html',context)
    return render(request,'index.html')

def delete_bed8(request,id):
    if 'username' in request.session:
...
def update_bed_basic_details8(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            room_type = request.POST.get('roomtype')
            ...
            return pg1_view_all_beds8(request)
        ...
        messages.info(request, 'BRANCH8 room created sucessfully')
        return render(request, 'branches/branch8/beds/update_bed.html', context)
    return render(request,'index.html')
