...
def may_print_live6(request):
    if 'username' in request.session:
        ...
        return render(request, 'branches/branch6/live_print_report/may_print_live.html', context)
    return render(request, 'index.html')
...
def june_print_live6(request):
    if 'username' in request.session:
        ...
        return render(request, 'branches/branch6/live_print_report/june_print_live.html', context)
    return render(request, 'index.html')

def june_dtails_live6(request):
    if 'username' in request.session:
        context = {
