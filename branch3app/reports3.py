...
def may_print_live3(request):
    if 'username' in request.session:
        ...
        return render(request, 'branches/branch3/live_print_report/may_print_live.html', context)
    return render(request, 'index.html')
...
def june_print_live3(request):
    if 'username' in request.session:
        ...
        return render(request, 'branches/branch3/live_print_report/june_print_live.html', context)
    return render(request, 'index.html')

def june_dtails_live3(request):
    if 'username' in request.session:
        context = {
            'details' : pg1_new_beds.objects.all(),
        }
