...
def branch1_dashboard3(request):
    if 'username' in request.session:
        return render(request, 'branches/branch3/branch1index.html')
    return render(request, 'index.html')


def admit_guest3(request):
    return render(request, 'branches/branch3/new_guest/admit_guest.html')
...
def view_all_new_guest3(request):
    if 'username' in request.session:
        l = []
        data = pg1_new_beds.objects.all()
        for i in data:
...
def update_br1_admit_guest3(request, id):
    if request.method == 'POST':
        selfmob = request.POST.get('selfmobno')
        # chk_mob = pg1_new_guest.objects.all().filter(self_mob=selfmob).exists()
        chk_mob = 10
        if chk_mob == 11:
            ...
            messages.info(request, 'BRANCH3 guest updated sucessfully')
            return view_all_new_guest3(request)
...
def vacate_br1_guest3(request, id):
    if request.method == 'POST':
        selfmob = request.POST.get('selfmobno')
        # chk_mob = pg1_new_guest.objects.all().filter(self_mob=selfmob).exists()
        chk_mob = 10
        if chk_mob == 11:
            ...
            messages.info(request, 'BRAMCH3 guest already exists')
            # return render(request, 'branches/branch1/new_guest/view_all_new_guest.html', context)
            return view_all_new_guest3(request)
        else:
            ...
            messages.info(request, 'BRANCH3 guest Vacated sucessfully')
            return view_all_new_guest3(request)
...
def unpaid_rent_choose_months3(request):
    if 'username' in request.session:
        return render(request, 'branches/branch3/reports/unpaid_rent/unpaid_rent_choose_months.html')


def jan_unpaid_rent3(request):
    if 'username' in request.session:
        context = {
        ...
        return render(request, 'branches/branch3/reports/unpaid_rent/unpaid_rent.html', context)


def feb_unpaid_rent3(request):
    if 'username' in request.session:
        context = {
...
def april_unpaid_rent3(request):
    if 'username' in request.session:
        context = {
...
def details_of_unpaid_guests3(request, id):
...
def paid_rent_choose_months3(request):
    if 'username' in request.session:
        return render(request, 'branches/branch3/reports/paid_rent/paid_rent_choose_months.html')


def jan_paid_rent3(request):
    if 'username' in request.session:
        l = []
        ...
        return render(request, 'branches/branch3/reports/paid_rent/paid_monthly_reports/jan_paid_rent.html', context)


def feb_paid_rent3(request):
    if 'username' in request.session:
        l = []
        ...
        return render(request, 'branches/branch3/reports/paid_rent/paid_monthly_reports/feb_paid_rent.html', context)


def mar_paid_rent3(request):
    if 'username' in request.session:
        l = []
        ...
        return render(request, 'branches/branch3/reports/paid_rent/paid_monthly_reports/mar_paid_rent.html', context)


def april_paid_rent3(request):
    if 'username' in request.session:
        l = []
        ...
        return render(request, 'branches/branch3/reports/paid_rent/paid_monthly_reports/april_paid_rent.html', context)


def may_paid_rent3(request):
    if 'username' in request.session:
        l = []
        ...
        return render(request, 'branches/branch3/reports/paid_rent/paid_monthly_reports/may_paid_rent.html', context)


def june_paid_rent3(request):
    if 'username' in request.session:
        l = []
        ...
        return render(request, 'branches/branch3/reports/paid_rent/paid_monthly_reports/june_paid_rent.html', context)


def july_paid_rent3(request):
    if 'username' in request.session:
        l = []
        ...
        return render(request, 'branches/branch3/reports/paid_rent/paid_monthly_reports/july_paid_rent.html', context)


def aug_paid_rent3(request):
    if 'username' in request.session:
        l = []
        ...
        return render(request, 'branches/branch3/reports/paid_rent/paid_monthly_reports/aug_paid_rent.html', context)


def sept_paid_rent3(request):
    if 'username' in request.session:
        l = []
        ...
        return render(request, 'branches/branch3/reports/paid_rent/paid_monthly_reports/sept_paid_rent.html', context)
...
def oct_paid_rent3(request):
    if 'username' in request.session:
        ...
        return render(request, 'branches/branch3/reports/paid_rent/paid_monthly_reports/oct_paid_rent.html', context)


def nov_paid_rent3(request):
    if 'username' in request.session:
        l = []
        ...
        return render(request, 'branches/branch3/reports/paid_rent/paid_monthly_reports/nov_paid_rent.html', context)


def dec_paid_rent3(request):
    if 'username' in request.session:
        l = []
        ...
        return render(request, 'branches/branch3/reports/paid_rent/paid_monthly_reports/dec_paid_rent.html', context)
...
def details_of_paid_guests3(request, id):
    rno = pg1_new_guest.objects.all().filter(id=id)
    l = []
    for i in rno:
        l.append(str(i.roon_no))
...
def choose_months3(request):
    if 'username' in request.session:
        return render(request,'branches/branch3/payments/choose_months.html')
...
def jan_manke_payments3(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
...
def feb_manke_payments3(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt=request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def march_manke_payments3(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt=request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def april_make_payments3(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt=request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def aug_make_payments3(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt=request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def sept_make_payments3(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt=request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def oct_make_payments3(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt=request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def nov_make_payments3(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt=request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def dec_make_payments3(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt=request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def choose_months_advance3(request):
    if 'username' in request.session:
        return render(request, 'branches/branch3/advance/choose_months_advance.html')


def jan_advance3(request):
    if 'username' in request.session:
        rn = request.POST.get('rno')
        context = {
            'pd': pg1_new_guest.objects.all().filter(roon_no=rn, flag=2, jan_rent_flag__gt=99),
...
def jan_make_payments_advance3(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def feb_make_payments_advance3(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def march_make_payments_advance3(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def april_make_payments_advance3(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def may_make_payments_advance3(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def june_make_payments_advance3(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
        ...
        return render(request, 'branches/branch3/advance/details_of_months/june/june_make_payments_advance.html',
                      context)
    return render(request, 'index.html')


def july_advance3(request):
    if 'username' in request.session:
        rn = request.POST.get('rno')
        context = {
            'pd': pg1_new_guest.objects.all().filter(roon_no=rn, flag=2, july_rent_flag__gt=99),
...
def july_make_payments_advance3(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def auguest_make_payments_advance3(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def sept_make_payments_advance3(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def october_make_payments_advance3(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def nov_make_payments_advance3(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def dec_make_payments_advance3(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def detail_guest_general3(request):
    if 'username' in request.session:
        l = []
        data = pg1_new_beds.objects.all()
        for i in data:
        ...
        g1_data = pg1_new_beds.objects.all().filter(roon_no=1),
        print('room share type of branch32', ll)
        print('room share type of branchl0', ll[0])
        print('room share type of branchl1', ll[1])
...
def jan_close3(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(jan='', branch_name='branch3').exists()
        print(chk)
        if chk == True:
            ...
            bc = branch_closing.objects.get(branch_name='branch3')
            bc.jan = 1
            bc.save()
            return feb_print3(request)

    return render(request, 'index.html')


def jan_close_decision_page3(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(jan='', branch_name='branch3').exists()
        print(chk)
        if chk == True:
...
def feb_close3(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(feb='', branch_name='branch3').exists()
        print(chk)
        if chk == True:
            conn = py.connect(host=database_host, user=database_user, password=database_password,
                              database=database_name)
            ...
            bc.feb = 1
            bc.save()
            return march_print3(request)

    return render(request, 'index.html')


def feb_close_decision_page3(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(feb='', branch_name='branch3').exists()
        print(chk)
        if chk == True:
...
def mar_close3(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(mar='', branch_name='branch3').exists()
        ...
        if chk == True:
            ...
            bc.mar = 1
            bc.save()
            return april_print3(request)
    return render(request, 'index.html')


def mar_close_decision_page3(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(mar='', branch_name='branch3').exists()
        print(chk)
        if chk == True:
...
def apr_close3(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(apr='', branch_name='branch3').exists()
        print(chk)
        if chk == True:
            conn = py.connect(host=database_host, user=database_user, password=database_password,
                              database=database_name)
            ...
            bc.apr = 1
            bc.save()
            return may_print3(request)
    return render(request, 'index.html')


def apr_close_decision_page3(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(apr='', branch_name='branch3').exists()
        print(chk)
        if chk == True:
...
def may_close3(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(may='', branch_name='branch3').exists()
        print(chk)
        if chk == True:
            conn = py.connect(host=database_host, user=database_user, password=database_password,
                              database=database_name)
            ...
            bc.may = 1
            bc.save()
            return june_print3(request)
    return render(request, 'index.html')


def may_close_decision_page3(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(may='', branch_name='branch3').exists()
        print(chk)
        if chk == True:
...
def jun_close3(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(jun='', branch_name='branch3').exists()
        print(chk)
        if chk == True:
            conn = py.connect(host=database_host, user=database_user, password=database_password,
                              database=database_name)
            ...
            bc.jun = 1
            bc.save()
            return july_print3(request)
    return render(request, 'index.html')


def jun_close_decision_page3(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(jun='', branch_name='branch3').exists()
        print(chk)
        if chk == True:
...
def jul_close3(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(jul='', branch_name='branch3').exists()
        print(chk)
        if chk == True:
            conn = py.connect(host=database_host, user=database_user, password=database_password,
                              database=database_name)
            ...
            bc.jul = 1
            bc.save()
            return aug_print3(request)
    return render(request, 'index.html')


def jul_close_decision_page3(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(jul='', branch_name='branch3').exists()
        print(chk)
        if chk == True:
...
def aug_close3(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(aug='', branch_name='branch3').exists()
        print(chk)
        if chk == True:
            conn = py.connect(host=database_host, user=database_user, password=database_password,
                              database=database_name)
            ...
            bc.aug = 1
            bc.save()
            return sept_print3(request)
    return render(request, 'index.html')


def aug_close_decision_page3(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(aug='', branch_name='branch3').exists()
        print(chk)
        if chk == True:
...
def sep_close3(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(sep='', branch_name='branch3').exists()
        ...
        if chk == True:
            ...
            bc.sep = 1
            bc.save()
            return oct_print3(request)
    return render(request, 'index.html')


def sep_close_decision_page3(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(sep='', branch_name='branch3').exists()
        print(chk)
        if chk == True:
...
def oct_close3(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(oct='', branch_name='branch3').exists()
        print(chk)
        if chk == True:
            conn = py.connect(host=database_host, user=database_user, password=database_password,
                              database=database_name)
            ...
            bc.oct = 1
            bc.save()
            return nov_print3(request)
    return render(request, 'index.html')


def oct_close_decision_page3(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(oct='', branch_name='branch3').exists()
        print(chk)
        if chk == True:
...
def nov_close3(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(nov='', branch_name='branch3').exists()
        print(chk)
        if chk == True:
            conn = py.connect(host=database_host, user=database_user, password=database_password,
                              database=database_name)
            ...
            bc.nov = 1
            bc.save()
            return dec_print3(request)
    return render(request, 'index.html')


def nov_close_decision_page3(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(nov='', branch_name='branch3').exists()
        print(chk)
        if chk == True:
...
def details_of_vacate_guest3(request, id):
    context = {
        'user_details': pg1_new_guest.objects.all().filter(id=id),
    }
...
def jan_manke_payments_vacate3(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
        ...
        return render(request, 'branches/branch3/payments/details_of_months/jan/jan_manke_payments_vacate.html',
                      context)


def feb_manke_payments_vacate3(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
        ...
        return render(request, 'branches/branch3/payments/details_of_months/feb/feb_manke_payments_vacate.html',
                      context)


def march_manke_payments_vacate3(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
        ...
        return render(request, 'branches/branch3/payments/details_of_months/march/march_manke_payments_vacate.html',
                      context)


def april_make_payments_vacate3(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
        ...
        return render(request,
                      'branches/branch3/vacate_guest/vacate_payments/details_of_months/april/april_make_payments_vacate.html',
                      context)
    return render(request, 'index.html')


def may_make_payments_vacate3(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
        ...
        return render(request,
                      'branches/branch3/vacate_guest/vacate_payments/details_of_months/may/may_make_payments_vacate.html',
                      context)


def june_make_payments_vacate3(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
        ...
        return render(request,
                      'branches/branch3/vacate_guest/vacate_payments/details_of_months/june/june_make_payments_vacate.html',
                      context)


def july_make_payments_vacate3(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
        ...
        return render(request,
                      'branches/branch3/vacate_guest/vacate_payments/details_of_months/july/july_make_payments_vacate.html',
                      context)


def aug_make_payments_vacate3(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
        ...
        return render(request,
                      'branches/branch3/vacate_guest/vacate_payments/details_of_months/aug/aug_make_payments_vacate.html',
                      context)


def sept_make_payments_vacate3(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
        ...
        return render(request,
                      'branches/branch3/vacate_guest/vacate_payments/details_of_months/sept/sept_make_payments_vacate.html',
                      context)


def oct_make_payments_vacate3(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
        ...
        return render(request,
                      'branches/branch3/vacate_guest/vacate_payments/details_of_months/oct/oct_make_payments_vacate.html',
                      context)


def nov_make_payments_vacate3(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
        ...
        return render(request,
                      'branches/branch3/vacate_guest/vacate_payments/details_of_months/nov/nov_make_payments_vacate.html',
                      context)


def dec_make_payments_vacate3(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
