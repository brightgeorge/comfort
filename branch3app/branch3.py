...
def active_guest_details3(request,guest_code):
...
def jan_paid_rent3(request):
    if 'username' in request.session:
        ...
        context = {
            ...
            'up': pg1_new_guest.objects.all().filter(jan_rent_flag=200, flag=1).order_by('roon_no'),
            'name': request.session['username'],
            'amt': s,
            'month_name': 'JAN'
        }
...
def feb_paid_rent3(request):
    if 'username' in request.session:
        ...
        context = {
            ...
            'up': pg1_new_guest.objects.all().filter(feb_rent_flag=200, flag=1).order_by('roon_no'),
...
def mar_paid_rent3(request):
    if 'username' in request.session:
        ...
        context = {
            ...
            'up': pg1_new_guest.objects.all().filter(march_rent_flag=200, flag=1).order_by('roon_no'),
            'name': request.session['username'],
            'amt': s,
            'month_name': 'MARCH'
        }
...
def get_total_due_year_end3(request):
    if 'username' in request.session:
        l = []
        data = pg1_new_beds.objects.all()
        for i in data:
        ...
        return render(request, 'branches/branch3/print_outs/get_total_due_year_end.html', context)
    return render(request, 'index.html')
...
def full_vacated_guest_details3(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def full_vacated_guest_table3(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def view_jan_account_details3(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def jan_account_mgt3(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
...
def view_feb_account_details3(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def feb_account_mgt3(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            paid_amt = request.POST.get('pamt')
            advance = request.POST.get('adv')
...
def view_march_account_details3(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def march_account_mgt3(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            paid_amt = request.POST.get('pamt')
            advance = request.POST.get('adv')
...
def view_april_account_details3(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def april_account_mgt3(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            paid_amt = request.POST.get('pamt')
            advance = request.POST.get('adv')
...
def view_auguest_account_details3(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def auguest_account_mgt3(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            paid_amt = request.POST.get('pamt')
            advance = request.POST.get('adv')
...
def view_sept_account_details3(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def sept_account_mgt3(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            paid_amt = request.POST.get('pamt')
            advance = request.POST.get('adv')
...
def view_october_account_details3(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def october_account_mgt3(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            paid_amt = request.POST.get('pamt')
            advance = request.POST.get('adv')
...
def view_nov_account_details3(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def nov_account_mgt3(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            paid_amt = request.POST.get('pamt')
            advance = request.POST.get('adv')
...
def view_dec_account_details3(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def dec_account_mgt3(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            paid_amt = request.POST.get('pamt')
            advance = request.POST.get('adv')
...
def guest_details3(request,guest_code):
    ...
    return render(request, 'branches/branch3/vacate_guest/guest_details.html', context)
...
def custom_background_regi3(request):
    if 'username' in request.session:
        us = request.session['username']
        th = request.POST.get('theme')
        uc=background_color.objects.all().filter(username=us).exists()
